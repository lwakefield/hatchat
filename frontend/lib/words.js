...
export const randomWordString = () => {
    return choose(ADVERB) + choose(PLURALNOUN) + choose(VERB) + choose(ADVERB);
}

export const randomName = () => {
    return choose(ADJECTIVE) + choose(PLURALNOUN);
}
